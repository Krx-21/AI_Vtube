...
if __name__ == "__main__":
    ...
    # Test message
    test_message = "ฮายยย~! ไพลินเองจ้า! พร้อมเมคเฟรนด์แล้วน้า! มีอะไรอยากเม้าท์มอยหรือปรึกษาไพลินไหมเอ่ย? บอกมาได้เล้ย! วันนี้ไพลินอารมณ์ดี๊ดี อยากหาเพื่อนคุยสุดๆ ไปเลยค่า!"
